...
public class AppDbContext : DbContext
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product { Id = 7, Name = "Biodegradable Labels", Slug = "biodegradable-labels", ShortDescription = "Sustainable labeling solutions for disposable items, fully compostable materials.", CategoryId = 5, ImageUrl = "https://honestlabel.in/wp-content/uploads/2025/02/Biodegradable-Labels-for-Disposable-Items-3.png", IsFeatured = true },
